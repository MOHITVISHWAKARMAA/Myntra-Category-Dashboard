# 👗 Myntra Strategic Category Command Center
...
2. **Inventory Aging:** Visualized 'Dead Stock' (90+ days) to plan proactive markdowns and protect **Gross Margin**.
3. **Pricing ROI:** Analyzed the correlation between discounts and revenue to identify the point of diminishing returns.

## 🛠️ Tech Stack Used
- **Power BI / Excel:** Advanced Visualization & DAX.
- **SQL:** Data Extraction & Cleaning.
- **Python:** Automated Data Pipeline for 1,000+ records.
